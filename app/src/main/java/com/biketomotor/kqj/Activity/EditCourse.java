...
public class EditCourse extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "TagEditCourse";
    ...
    private void initView() {
        ...
        btEditCourse = findViewById(R.id.bt_edit_course);
        ...
        btEditCourse.setOnClickListener(this);
    ...
    private void initCourse() {
        CourseList.Course course = CourseList.courseMap.get(courseID);
        courseName = course.courseName;
        classroom = course.classroom;
        teacher = course.teacher;
        selectedStartLesson = course.startLesson - 1;
        selectedEndLesson = course.endLesson - 1;
        selectedWeekday = course.weekday - 1;
        selectedWeeks.clear();
        for (int i : course.weeks) {
            weeksStatus[i - 1] = true;
            selectedWeeks.add(i);
        }
        ...
        tvSelectWeeks.setText("共" + course.weeks.size() + "周");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_end_lesson:
                selectEndLesson();
                break;
            case R.id.bt_edit_course:
                Log.e(TAG, "json:" + getJsonData());
                if (isInfoValid()) {
                    editCourse();
                }
                break;
    ...
    private void editCourse() {
        HttpsUtil.sendPostRequest(HttpsUtil.editCourseAddr, getJsonData(), new HttpsListener() {
            @Override
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.e(TAG, "editCourse/onSuccess:" + e.toString());
                        }
                    }
                });
            }
            ...
            public void onFailure(Exception exception) {
                Log.e(TAG, "editCourse/onFailure:" + exception.toString());
            }
        });
    }
    ...
    public static void actionActivity(Context context, int courseId) {
